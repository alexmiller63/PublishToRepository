...
- Strict mailbox JSON and repository verification are functioning for simple create and replacement operations.
- Revision-controlled mailbox clearing worked after Test 1.
